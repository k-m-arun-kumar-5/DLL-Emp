Description :
=============
I, K.M. Arun Kumar alias Arunkumar Murugeswaran, just shared my works, which I worked as learning path and practiced some C programming such as Employee's Record using ordered and unique EmpID as key in Double Linked List, which as transverse forward or backward based on given Emp ID.
